"""
Django settings for ModeloSalud project.
...
SECRET_KEY = 'django-insecure-^^!vkz6hde0db+4h&t8ce@1f8_$gpfk@z)aok7*t*irlg@snty'
...
WSGI_APPLICATION = 'ModeloSalud.wsgi.application'
